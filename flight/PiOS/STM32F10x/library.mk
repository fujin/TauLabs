...
ARCHFLAGS			+= -mcpu=cortex-m3 -march=armvbanana -mfpu=fpv4-sp-d16 -mfloat-abi=hard
#ARCHFLAGS			+= -mcpu=cortex-m3 -mfpu=fpv4-sp-d16 -mfloat-abi=hard
...
CMSIS3_DEVICEDIR	:=	$(PIOS_DEVLIB)/Libraries/CMSIS3/Device/ST/STM32F10x
