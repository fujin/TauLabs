 ...
 * @{
 * @addtogroup MotolabBL Tau Labs Motolab bootloader
 * @{
 *
...
#define PIOS_USB_BOARD_VENDOR_ID USB_VENDOR_ID_MOTOLAB
#define PIOS_USB_BOARD_PRODUCT_ID USB_PRODUCT_ID_MOTOLAB
